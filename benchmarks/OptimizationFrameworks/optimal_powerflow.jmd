...
solve_opf_optimization("data/pglib_opf_case5_pjm.m")
```
...
solve_opf_jump("data/pglib_opf_case5_pjm.m")
```
...
solve_opf_nlpmodels("data/pglib_opf_case5_pjm.m")
```
...
solve_opf_nonconvex("data/pglib_opf_case5_pjm.m")
```
...
solve_opf_optim("data/pglib_opf_case5_pjm.m")
```
...
solve_opf_casadi("data/pglib_opf_case5_pjm.m")
```